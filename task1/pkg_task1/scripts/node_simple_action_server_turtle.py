...
class SimpleActionServerTurtle:
    ...
    def __init__(self):
        ...
        self._sas = actionlib.SimpleActionServer('/action_turtle', msgTurtleAction, execute_cb=self.func_on_rx_goal, auto_start=False)
        '''
    ...
    def func_on_rx_goal(self, obj_msg_goal):
        ...
        obj_msg_result.turtle_x = self._curr_x
        obj_msg_result.turtle_y = self._curr_y
        obj_msg_result.turtle_theta = self._curr_theta
...
def main():
    ...
    rospy.Subscriber(obj_server._config_ros_sub_topic, Pose, obj_server.func_ros_sub_callback)
